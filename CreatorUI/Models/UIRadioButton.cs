...
namespace CreatorUI.Models
{
    ...
    {
        [Description("The width of radiobutton component.")]
        public int width { get; set; }
        [Description("The height of radiobutton component.")]
        public int height { get; set; }
        [Description("Defines if the radiobutton is checked.")]
        public bool _checked { get; set; }
        [Description("Defines if to disable the radiobutton.")]
        public bool disabled { get; set; }
        [Description("The label bound to the radiobutton.")]
        ...
        [Description("The label alignment. Possible values are:'left','right'.")]
        [TypeConverter(typeof(CheckBoxLabelAlignConverter))]
        public string labelAlign { get; set; }

        public UIRadioButton()
        {
            EditorId = "UIRadioButton";
            Info = "UIRadioButton: ";
            width = 20;
            height = 20;
            _checked = false;
        ...
        public string GenHtmlEditor()
        {
            var sb = new StringBuilder();
            sb.Append($"<div style=\"display:inline-block;\" id=\"{EditorId}\" onClick=\"cefAPI.selUIObject('{EditorId}', false); event.stopPropagation();\" ><input name=\"test\" type=\"radio\" ");
            sb.Append(GetDataOptions());
            sb.Append(" class=\"easyui-radiobutton\"");
            sb.Append("/></div>\r\n");
        ...
        public override JsonUIObject GetJsonObject()
        {
            ...
            jsonObj.Info = Info;
            jsonObj.UIComponentName = "UIRadioButton";
