...
{
    public class UIDataGrid : UIObject
    {
        ...
        public override string GetHTMLObject(GenHTMLType GenType, bool modalSupport)
        {
            ...
            {
                sb.Append($"<div style=\"display:block;width:100%;height:100%;\" id=\"{EditorId}\" onClick=\"cefAPI.selUIObject('{EditorId}', false); event.stopPropagation();\"><table class=\"easyui-datagrid\" ");
            }
            else
            {
                sb.Append($"<table ");
        ...
        public override JsonUIObject GetJsonObject()
        {
            ...
            jsonObj.Info = Info;
            jsonObj.UIComponentName = "UIDataGrid";
